...
public class ListFoodsActivity extends BaseActivity {
   ...
   private Category category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getIntentExtra();
        initList(category.getId());
    }

    private void initList(int categoryIdParam)
    {
        ...
        {
            query = myRef.orderByChild("CategoryId").equalTo(categoryIdParam);
        }
    ...
    private void getIntentExtra() {
        ...
        binding.titleText.setText(category.getName());
